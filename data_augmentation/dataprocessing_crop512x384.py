...
if __name__ == '__main__':
    ...
    #    if name != 'akhira':
    #        if name == 'raul':
    #            angle = ['n60', 'n80', 'n100', 'n120', 'n140', 'n160', 'n180'] 
    #        else: 
    #            angle = ['0', '20', '40', '60', '80', '100', '120', '140', '160', '180', 'n20', 'n40', 'n60', 'n80', 'n100', 'n120', 'n140', 'n160', 'n180']  
    #        #count += 1
    #        filename = '{}_{}_{}'.format(action[1], name, lighting[1]) 
    ...
    for act in action:
        for name in person:
            #count += 1
            if name == 'eliana' and act == 'rotate':
                angle = ['160', '180', 'n20', 'n40', 'n60', 'n80', 'n100', 'n120', 'n140', 'n160', 'n180']
            else:
                angle = ['0', '20', '40', '60', '80', '100', '120', '140', '160', '180', 'n20', 'n40', 'n60', 'n80', 'n100', 'n120', 'n140', 'n160', 'n180']
            filename = '{}_{}_{}'.format(act, name, lighting[2]) 
            #print(count, filename)
